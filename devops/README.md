...
DEPLOY_ENV=prod
DEPLOY_HOST=ploneconf2024-helen-araujo.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
DOCKER_CONFIG=.docker
STACK_NAME=ploneconf2024-helen-araujo-tangrama-com-br
```
...
You need either a Ubuntu or Debian based system for ploneconf2024-helen-araujo.tangrama.com.br, enable SSH, and install a supported version of Python 3 on that system.
...
prod:
  hosts:
    ploneconf2024-helen-araujo.tangrama.com.br:
      ansible_user: root
      host: ploneconf2024-helen-araujo
      hostname: ploneconf2024-helen-araujo.tangrama.com.br
```
...
Deploy the stack defined in `devops/stacks/ploneconf2024-helen-araujo.tangrama.com.br.yml` to the remote server with:
